...
def retrieve_password(email: str):
    ...
    if user:
        ...
        return jsonify(message="This email doesn't exist")
...
def add_planet():
    ...
    if test:
        return jsonify("There's already a planet with that name"), 409
    else:
...
def update_planet():
    ...
    planet = Planet.query.filterby(planet_id=planet_id).first()
    if planet:
